...
<head>
	...
	<link rel ="stylesheet" type ="text/css" href ="Estilos_Login_Publicar_Couch.css"/>	
</head>
<body>
	<?php
	...
	<div id= "cuerpo">
		<div id= "publicar">
			...
			<form method="post" name="activar">
				...
				<div id= "formulario">
					&#191Esta seguro que quiere publicar este hospedaje?
					<div id="boton">
						<div id= "boton1">
				...
				<?php
					if (isset($_POST['aceptar'])) {
						...
						<script type="text/javascript">
							alert ("El hospedaje se ha vuelto a publicar");
